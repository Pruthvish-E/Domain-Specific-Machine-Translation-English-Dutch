...
MODEL_NAME = "models/encdec/software_mt"
...
def run_eval(dataset_path, tag):
    ...
    df.to_csv(f"results/encdec_finetuned_{tag}_predictions.csv", index=False)
...
if __name__ == "__main__":
    ...
    pd.DataFrame(all_metrics).to_csv("results/encdec_finetuned_metrics.csv")
