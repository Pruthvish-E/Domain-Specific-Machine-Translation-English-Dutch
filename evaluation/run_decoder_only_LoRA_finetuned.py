...
def run_eval(dataset_path, tag):
    ...
    model = PeftModel.from_pretrained(base, "models/decoder_only_lora")
    model.eval()
    ...
    df.to_csv(f"results/deconly_LoRA_finetuned_{tag}_predictions.csv", index=False)
...
if __name__ == "__main__":
    ...
    pd.DataFrame(all_metrics).to_csv("results/deconly_LoRA_finetuned_metrics.csv")
